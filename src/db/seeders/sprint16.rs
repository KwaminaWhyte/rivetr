...
"#,
        ...
        (
            "tpl-zulip",
            "Zulip",
            "Powerful open-source team chat with threaded conversations. Email-style threading keeps conversations organized.",
            "communication",
            "zulip",
            r#"services:
  zulip:
    ...
    environment:
      ...
      - SECRETS_secret_key=${SECRET_KEY:-changeme-zulip-secret}
  ...
  zulip_db:
    ...
    environment:
      ...
      - POSTGRES_PASSWORD=${DB_PASSWORD:-changeme}
    volumes:
      - zulip_db_data:/var/lib/postgresql/data
    labels:
      - "rivetr.managed=true"
...
volumes:
  ...
  zulip_rabbitmq_data:
"#,
            r#"[{"name":"EXTERNAL_HOST","label":"External Hostname","required":true,"default":"localhost","secret":false},{"name":"ADMIN_EMAIL","label":"Admin Email","required":true,"default":"admin@example.com","secret":false},{"name":"SECRET_KEY","label":"Secret Key","required":true,"default":"changeme-zulip-secret","secret":true},{"name":"DB_PASSWORD","label":"Database Password","required":true,"default":"changeme","secret":true},{"name":"RABBITMQ_PASSWORD","label":"RabbitMQ Password","required":false,"default":"changeme","secret":true},{"name":"SMTP_PASSWORD","label":"SMTP Password","required":false,"default":"","secret":true},{"name":"DISABLE_HTTPS","label":"Disable HTTPS","required":false,"default":"true","secret":false},{"name":"PORT","label":"HTTP Port","required":false,"default":"80","secret":false},{"name":"HTTPS_PORT","label":"HTTPS Port","required":false,"default":"443","secret":false}]"#,
        ),
        (
            "tpl-chatwoot",
            "Chatwoot",
            "Open-source customer support platform. Omnichannel inbox for email, live chat, social media, and more.",
            "communication",
            "chatwoot",
            r#"services:
  chatwoot-rails:
    ...
    environment:
      - SECRET_KEY_BASE=${SECRET_KEY_BASE:-changeme-secret-key-base-64chars}
      - FRONTEND_URL=${FRONTEND_URL:-http://localhost:3000}
      - DATABASE_URL=postgres://chatwoot:${DB_PASSWORD:-changeme}@chatwoot_db:5432/chatwoot
...
volumes:
  ...
  chatwoot_redis_data:
"#,
            r#"[{"name":"SECRET_KEY_BASE","label":"Secret Key Base","required":true,"default":"changeme-secret-key-base-64chars","secret":true},{"name":"FRONTEND_URL","label":"Frontend URL","required":true,"default":"http://localhost:3000","secret":false},{"name":"DB_PASSWORD","label":"Database Password","required":true,"default":"changeme","secret":true},{"name":"PORT","label":"Host Port","required":false,"default":"3000","secret":false}]"#,
        ),
...
"#,
        ...
        (
            "tpl-langfuse",
            "Langfuse",
            "Open-source LLM observability and analytics. Trace, debug, and evaluate your LLM applications in production.",
            "ai",
            "langfuse",
            r#"services:
  langfuse:
    ...
    ports:
      - "${PORT:-3000}:3000"
    environment:
      - DATABASE_URL=postgres://langfuse:${DB_PASSWORD:-changeme}@langfuse_db:5432/langfuse
      - NEXTAUTH_SECRET=${NEXTAUTH_SECRET:-changeme-nextauth-secret}
      - NEXTAUTH_URL=${NEXTAUTH_URL:-http://localhost:3000}
      - SALT=${SALT:-changeme-salt}
      - LANGFUSE_ENABLE_EXPERIMENTAL_FEATURES=${ENABLE_EXPERIMENTAL:-false}
    depends_on:
      - langfuse_db
    labels:
      - "rivetr.managed=true"
...
volumes:
  langfuse_db_data:
"#,
            r#"[{"name":"NEXTAUTH_SECRET","label":"NextAuth Secret","required":true,"default":"changeme-nextauth-secret","secret":true},{"name":"NEXTAUTH_URL","label":"App URL","required":true,"default":"http://localhost:3000","secret":false},{"name":"SALT","label":"Salt","required":true,"default":"changeme-salt","secret":true},{"name":"DB_PASSWORD","label":"Database Password","required":true,"default":"changeme","secret":true},{"name":"ENABLE_EXPERIMENTAL","label":"Enable Experimental Features","required":false,"default":"false","secret":false},{"name":"PORT","label":"Host Port","required":false,"default":"3000","secret":false}]"#,
        ),
        (
            "tpl-localai",
            "LocalAI",
            "Self-hosted OpenAI-compatible API. Run LLMs, image generation, and speech models locally — no cloud required.",
            "ai",
            "localai",
            r#"services:
  localai:
...
volumes:
  localai_models:
"#,
            r#"[{"name":"THREADS","label":"CPU Threads","required":false,"default":"4","secret":false},{"name":"CONTEXT_SIZE","label":"Context Size","required":false,"default":"512","secret":false},{"name":"API_KEY","label":"API Key (optional)","required":false,"default":"","secret":true},{"name":"PORT","label":"Host Port","required":false,"default":"8080","secret":false}]"#,
        ),
...
"#,
        ...
        (
            "tpl-monica",
            "Monica",
            "Personal CRM to organize your relationships. Track contacts, interactions, notes, and life events.",
            "business",
            "monica",
            r#"services:
  monica:
    ...
    environment:
      - APP_ENV=production
      - APP_KEY=${APP_KEY:-base64:changemechangemechangemechangeme32}
      ...
      - MAIL_HOST=${SMTP_HOST:-smtp.example.com}
      - MAIL_PORT=${SMTP_PORT:-587}
      - MAIL_FROM_ADDRESS=${EMAIL_FROM:-no-reply@example.com}
    depends_on:
      - monica_db
    volumes:
...
volumes:
  ...
  monica_db_data:
"#,
            r#"[{"name":"APP_KEY","label":"App Key (base64:...)","required":true,"default":"base64:changemechangemechangemechangeme32","secret":true},{"name":"APP_URL","label":"App URL","required":false,"default":"http://localhost","secret":false},{"name":"DB_PASSWORD","label":"Database Password","required":true,"default":"changeme","secret":true},{"name":"DB_ROOT_PASSWORD","label":"DB Root Password","required":false,"default":"rootchangeme","secret":true},{"name":"MAIL_MAILER","label":"Mail Driver","required":false,"default":"log","secret":false},{"name":"SMTP_HOST","label":"SMTP Host","required":false,"default":"smtp.example.com","secret":false},{"name":"SMTP_PORT","label":"SMTP Port","required":false,"default":"587","secret":false},{"name":"EMAIL_FROM","label":"From Email","required":false,"default":"no-reply@example.com","secret":false},{"name":"PORT","label":"Host Port","required":false,"default":"80","secret":false}]"#,
        ),
        (
            "tpl-listmonk",
            "Listmonk",
            "High-performance self-hosted newsletter and mailing list manager. Manage subscribers, campaigns, and transactional emails.",
            "business",
            "listmonk",
            r#"services:
  listmonk:
    ...
    environment:
      ...
      - LISTMONK_db__password=${DB_PASSWORD:-changeme}
...
volumes:
  ...
  listmonk_db_data:
"#,
            r#"[{"name":"DB_PASSWORD","label":"Database Password","required":true,"default":"changeme","secret":true},{"name":"PORT","label":"Host Port","required":false,"default":"9000","secret":false}]"#,
        ),
        (
            "tpl-cal-com",
            "Cal.com",
