-- Migration 072: Add 'mattermost', 'lark', 'gotify', 'resend' to notification_channels channel_type CHECK constraint
...
CREATE TABLE IF NOT EXISTS notification_channels_new (
    ...
    name TEXT NOT NULL,
    channel_type TEXT NOT NULL CHECK(channel_type IN ('slack', 'discord', 'email', 'webhook', 'telegram', 'teams', 'pushover', 'ntfy', 'mattermost', 'lark', 'gotify', 'resend')),
